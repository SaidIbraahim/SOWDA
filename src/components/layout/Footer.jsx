    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-bold mb-4">About SOWDA</h3>
            <p className="text-gray-300">
              Supporting women's development and empowerment in Garowe through education,
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/support" className="text-gray-300 hover:text-white">Support Us</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>&copy; {new Date().getFullYear()} SOWDA. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
